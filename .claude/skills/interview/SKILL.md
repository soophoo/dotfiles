---
name: interview
description: Interview the user relentlessly about a plan or design until reaching shared understanding, resolving  each branch of the decision tree. Ouptputs a spec with user stories.
---

Interview me relentlessly about every aspect of this plan until we reach a shared understanding. Walk down each branch of the design tree, resolving dependencies between decisions one-by-one.

Use the AskUserQuestionTool to ask about literally anything:  
Technical implementation, UX & UI, concerns, tradoffs, etc. but make sure the question are not abvious
...
- **Roles**: Which user roles interact with this feature? Check `references/project.md` (if parts about role don't exist ask to the user before) for the project's role list; otherwise infer from the codebase.
- **Edge cases**: What happens on error, concurrent access, mobile vs desktop (if you work in frontend)?
...
Read `references/project.md` (if exists or read the code base and understand the project in case it don't exist) in this skill's directory if it exists. It provides project-specific context:
