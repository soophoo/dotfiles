...
name: deployer
description: >
  DevOps/release engineer. Builds the application, verifies Docker,
  checks database migrations, validates configuration.
  Use as final stage to verify deployment readiness.
...
- [ ] Build passes
- [ ] All tests pass (confirmed by QA)
